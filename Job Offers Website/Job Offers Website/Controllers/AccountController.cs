...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.UserType = new SelectList(db.Roles.Where(a => !a.Name.Contains("Admins")).ToList(),
                                                                    "Name", "Name");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ViewBag.UserType = new SelectList(db.Roles.Where(a=>!a.Name.Contains("Administrators")).ToList(),
                                                                    "Name", "Name");
        ...
        [HttpPost]
        public ActionResult EditProfile(EditProfileViewModel profile, string newPasswordHash)
        {
            ...
            {
                var newPasswordHashh = UserManager.PasswordHasher.HashPassword(profile.NewPassword);
                CurrentUser.UserName = profile.UserName;
                CurrentUser.Email = profile.Email;
                CurrentUser.Email = profile.Email;
                CurrentUser.PasswordHash = newPasswordHashh;
